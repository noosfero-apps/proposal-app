define(['handlebars'], function(Handlebars){
  ...
  Handlebars.registerHelper('list_proposal', function(proposals, options) {
    ...
    for(var i=0, j=proposals.length; i<j; i++) {
      ...
      category =  category + '</div>' + '<div class="box-body">' + '<img src="' + options.hash['host'] + proposal.image.url + '" alt="Imagem de apresentação do programa."/>' +  proposal.title + (proposal.abstract ? proposal.abstract : '') + '</div>';
